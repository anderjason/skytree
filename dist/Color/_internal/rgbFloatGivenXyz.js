...
function rgbFloatGivenXyz(xyzColor) {
    ...
    return {
        r: Ratio_1.Ratio.ofDecimal(numberWithHardLimit_1.numberWithHardLimit(r, 0, 1)),
        g: Ratio_1.Ratio.ofDecimal(numberWithHardLimit_1.numberWithHardLimit(g, 0, 1)),
        b: Ratio_1.Ratio.ofDecimal(numberWithHardLimit_1.numberWithHardLimit(b, 0, 1)),
    };
}
