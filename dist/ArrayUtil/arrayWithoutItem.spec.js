...
const arrayWithoutItem_1 = require("./arrayWithoutItem");
describe("arrayWithoutItem", () => {
    it("returns a new array with the specified item removed", () => {
        ...
        const result = arrayWithoutItem_1.arrayWithoutItem(items, third);
...
//# sourceMappingURL=arrayWithoutItem.spec.js.map